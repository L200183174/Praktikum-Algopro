...
##L2.place(x=0, y=40)
##str2 = StringVar(value='Azie Melasari')
...
##L3.place(x=0, y=60)
##str3 = StringVar(value='L200183174')
...
##L4.place(x=0, y=80)
##str4 = StringVar(value='Saranghae')
##E4 = Label(my_app, textvariable=str4)
##E4.grid(row=3, column=1)
##E4.place(x=150, y=80)
##
##L5 = Label(my_app , text = 'Idol Friends')
##L5.grid(row=4 , column=0)
##L5.place(x=0, y=100)
##str5 = StringVar(value='Ali bin Abi Tholib')
...
##L6.place(x=0, y=120)
##str6 = StringVar(value='Senyum Itu Ibadah')
